...
| **Fair**         | `(OK)` | 2.5 – 3.4 | Teal              | **Fleet Average Pass.** Moderate deviations (slightly wide downwind, slight glidepath error, minor lineup offset) safely managed to touchdown. |
